// Game data
const gameData = [
  { id: 1, image:'https://ucarecdn.com/f4539d01-c825-4ee4-9474-6678050c78d9/enpitsu.jpg', word: 'https://ucarecdn.com/8a0f4660-1334-449c-972c-866aafbb5b2f/kotobamochimono_page-0001.jpg' },
  { id: 2, image:'https://ucarecdn.com/81e61761-0135-4c63-a86c-9e5c5b5d60a0/borupen.jpg', word: 'https://ucarecdn.com/aac04658-1af4-4f0b-abe3-11119e16f849/kotobamochimono_page-0002.jpg' },
  { id: 3, image:'https://ucarecdn.com/e79d3e86-f5fa-48f8-b5e1-4322e1115e16/makapen.jpg', word: 'https://ucarecdn.com/61734829-81d1-46d8-b32f-a0ed29064ade/kotobamochimono_page-0003.jpg' },
  { id: 4, image:'https://ucarecdn.com/8ee773fb-eb85-4084-83d5-2ab4447b5dd1/nooto.jpg', word: 'https://ucarecdn.com/fc5dcb4a-bc8f-4f2c-8964-273ae1e5d031/kotobamochimono_page-0004.jpg' },
  { id: 5, image:'https://ucarecdn.com/a22543c6-c606-4bad-ab35-fea429939c8c/jougi.jpg', word: 'https://ucarecdn.com/22507c60-24e9-4d81-a156-f110bd56c348/kotobamochimono_page-0005.jpg' },
  { id: 6, image:'https://ucarecdn.com/b0aecc5e-a7d5-4f20-b18d-13acc48a044b/keshigomu.jpg', word: 'https://ucarecdn.com/9ea9a76c-19c9-4cc2-a8dc-f1f820e733fc/kotobamochimono_page-0006.jpg' },
  { id: 7, image:'https://ucarecdn.com/62414cbc-77c6-412b-ae4f-d5a20cc45c0b/gambarmochimono_page0007.jpg', word: 'https://ucarecdn.com/565fb8f4-d83d-4fa5-9186-63d5c7c02cb6/kotobamochimono_page-0007.jpg' },
  { id: 8, image:'https://ucarecdn.com/67a6547e-3589-4380-a78f-c3582ace00fe/gambarmochimono_page0008.jpg', word: 'https://ucarecdn.com/b78af9b7-d2c4-46ca-9368-e554db037d92/kotobamochimono_page-0008.jpg' },
  { id: 9, image:'https://ucarecdn.com/695ffc31-bafb-4468-b2e4-580ec03355c5/gambarmochimono_page0009.jpg', word: 'https://ucarecdn.com/4a17cc29-1b5d-4128-9805-01515486cbf5/kotobamochimono_page-0009.jpg' },
  { id: 10, image:'https://ucarecdn.com/d963aee8-34af-4e57-86b8-fc88f66b23e4/gambarmochimono_page0010.jpg', word: 'https://ucarecdn.com/19794856-8f2e-418c-b816-afc752e1edec/kotobamochimono_page-0010.jpg' }
];
...
function createCard(item, type) {
  ...
  const iconClass = type === "image" ? `<i class="fas fa-image text-white text-2xl"></i>` : `<i class="fas fa-image text-white text-2xl"></i>`; // Diubah dari fas fa-language menjadi fas fa-image

  const backContent = type === "image" ? createImageBackContent(item) : createWordBackContent(item);
...
function showStats() {
  ...
  sortedGames.forEach((game) => {
    ...
    const formattedDate = `${date.getDate().toString().padStart(2, "0")}/${(date.getMonth() + 1).toString().padStart(2, "0")}/${date.getFullYear()} ${date.getHours().toString().padStart(2, "0")}:${date
      .getMinutes()
      .toString()
      .padStart(2, "0")}`;
...
function clearStats() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire("Terhapus!", "Statistik permainan telah dihapus.", "success");
    }
  });
}
